...
class SettingsFragment : Fragment() {
    ...
    val aboutText = """
        ...
        <ul>
            <p>● Сократить количество ДТП на 10% — около 3,5 тысячи случаев в год</p>
            <p>● Уменьшить число пострадавших в ДТП на 10% — около 4,7 тысячи человек в год</p>
            <p>● Снизить расходы на обслуживание автомобиля на 35% — около 30 тысяч рублей на водителя в год</p>
            <p>● Ускорить обработку заявок жителей в 4 раза — время подачи заявки сокращается до 4 минут</p>
        ...
        <ol>
            <p>● Установите бесплатное приложение «Умные дороги».</p>
            <p>● Добавьте свой автомобиль в раздел «Гараж» и укажите место крепления смартфона для корректного сбора данных.</p>
            <p>● Передвигайтесь как обычно — приложение автоматически анализирует вибрации и ускорения, фиксирует дорожные проблемы и предупреждает об опасностях.</p>
            <p>● Ваша активность помогает создать точную интерактивную карту и сокращать количество аварий по всей стране.</p>
        </ol>
        
        <h3>Присоединяйтесь к изменениям!</h3>
        <p>Мы находимся на этапе активного роста и приглашаем к сотрудничеству:</p>
        <ul>
            <p>● Скачайте приложение и установите его в машину — даже 10 минут в день помогут собрать данные</p>
            <p>● Поделитесь впечатлениями в соцсетях — ваши отзывы помогают нам улучшать приложение</p>
            <p>● Расскажите друзьям — чем больше пользователей, тем точнее карта проблемных участков</p>
            <p>● Поддержите краудфандингом — ваши инвестиции ускорят запуск SOS-системы и других функций</p>
        </ul>
        ...
        <p><b>Контакты:</b><br> <a href="https://t.me/smart_road">t.me/smart_road</a> <br> 
        <a href="mailto:info@smart-roads.ru">info@smart-roads.ru</a> <br> 
